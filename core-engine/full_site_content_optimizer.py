...
def generate_all_site_content():
    ...
    for i, city in enumerate(cities, 1):
        ...
        keywords = f"{city_name}导航,{city_name}网站,{city_name}网址,{city_name}导航网站,{city_name}网站导航,{city_name}本地导航,{city_name}优质网站"
    ...
    for i, niche in enumerate(niches, 1):
        ...
        keywords = f"{niche_name}导航,{niche_name}网站,{niche_name}网址,{niche_name}行业导航,{niche_name}专业网站,{niche_name}行业资讯,{niche_name}专业导航"
    ...
    for i, hybrid in enumerate(hybrids, 1):
        ...
        keywords = f"{city_name}{niche_name}导航,{city_name}{niche_name}网站,{city_name}{niche_name}网址,{city_name}{niche_name}行业导航,{city_name}{niche_name}本地网站,{city_name}{niche_name}专业导航,{city_name}{niche_name}地区导航"
